...
class AddressFactory extends Factory
{
    ...
    {
        return [
            'user_id' => User::factory(), // Create a new user for each address
            ...
            'created_at' => $this->faker->dateTimeBetween('now', '+3 months'),
            'updated_at' => $this->faker->dateTimeBetween('+2 months', '+5 months'),
        ];
    }
}
